...
public class ClassroomEndpointTest {
	...
	public void createA() {
		...
		assertEquals(MOCK_VALUE2,endpoint.createAClassroom(MOCK_VALUE));
	...
	public void updateA() {
		...
		assertEquals(MOCK_VALUE2,endpoint.updateAClassroom(1L,MOCK_VALUE));
	...
	public void deleteA() {
		...
		assertEquals(MOCK_VALUE, endpoint.deleteAClassroom(1L));
